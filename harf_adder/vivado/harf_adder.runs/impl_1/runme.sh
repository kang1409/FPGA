...
HD_PWD='F:/progect/harf_adder/vivado/harf_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log harf_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source harf_adder.tcl -notrace
