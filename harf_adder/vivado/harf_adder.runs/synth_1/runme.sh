...
HD_PWD='F:/progect/harf_adder/vivado/harf_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log harf_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source harf_adder.tcl
