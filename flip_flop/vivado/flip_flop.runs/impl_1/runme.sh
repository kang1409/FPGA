...
HD_PWD='F:/project/flip_flop/vivado/flip_flop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flip_flop_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flip_flop_1.tcl -notrace
