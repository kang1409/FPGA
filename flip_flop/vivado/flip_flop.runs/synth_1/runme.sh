...
HD_PWD='F:/project/flip_flop/vivado/flip_flop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flip_flop_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flip_flop_1.tcl
