...
HD_PWD='F:/project/seg_dynamic/vivado/seg_dynamic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_dynatic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_dynatic.tcl -notrace
