...
HD_PWD='F:/project/seg_dynamic/vivado/seg_dynamic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_dynatic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_dynatic.tcl
