...
HD_PWD='F:/progect/mux2_1/vivado/Mux2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux2_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux2_1.tcl -notrace
