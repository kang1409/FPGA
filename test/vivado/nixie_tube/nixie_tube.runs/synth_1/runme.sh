...
HD_PWD='F:/project/test/vivado/nixie_tube/nixie_tube.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nixie_tube.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nixie_tube.tcl
