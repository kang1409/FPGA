...
HD_PWD='F:/project/test/vivado/nixie_tube/nixie_tube.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nixie_tube.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nixie_tube.tcl -notrace
