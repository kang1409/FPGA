...
HD_PWD='F:/project/seg_static/vivado/seg_static.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_ststic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_ststic.tcl
