...
HD_PWD='F:/project/seg_static/vivado/seg_static.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_ststic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_ststic.tcl -notrace
