...
HD_PWD='F:/project/IP/IP_PLL/PLL/PLL.runs/pll_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_ip.tcl
