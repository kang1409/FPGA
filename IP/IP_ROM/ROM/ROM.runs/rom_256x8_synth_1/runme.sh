...
HD_PWD='F:/project/IP/IP_ROM/ROM/ROM.runs/rom_256x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_256x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_256x8.tcl
