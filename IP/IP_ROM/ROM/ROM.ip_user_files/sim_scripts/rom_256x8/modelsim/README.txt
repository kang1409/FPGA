...
#
# Generated by export_simulation on Mon Sep 18 17:51:19 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './rom_256x8.sh' script.

./rom_256x8.sh -reset_run
...
./rom_256x8.sh -noclean_files

For more information on the script, please type './rom_256x8.sh -help'.
