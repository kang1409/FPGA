...
HD_PWD='F:/project/IP/IP_RAM/RAM/RAM.runs/ram_256x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_256x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_256x8.tcl
