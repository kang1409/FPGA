...
HD_PWD='F:/project/IP/IP_FIFO/SCFIFO/SCFIFO.runs/scfifo_256x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scfifo_256x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scfifo_256x8.tcl
