...
#
# Generated by export_simulation on Thu Sep 21 20:17:41 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './scfifo_256x8.sh' script.

./scfifo_256x8.sh -reset_run
...
./scfifo_256x8.sh -noclean_files

For more information on the script, please type './scfifo_256x8.sh -help'.
