...
HD_PWD='F:/project/VGA/vga_char/char.runs/pll_108_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_108.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_108.tcl
