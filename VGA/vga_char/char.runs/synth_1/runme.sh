...
HD_PWD='F:/project/VGA/vga_char/char.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_char.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_char.tcl
