...
HD_PWD='F:/project/VGA/vga_char/char.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_char.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_char.tcl -notrace
