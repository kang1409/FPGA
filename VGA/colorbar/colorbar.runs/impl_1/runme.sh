...
HD_PWD='F:/project/VGA/colorbar/colorbar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vag_colorbar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vag_colorbar.tcl -notrace
