...
HD_PWD='F:/project/VGA/colorbar/colorbar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vag_colorbar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vag_colorbar.tcl
