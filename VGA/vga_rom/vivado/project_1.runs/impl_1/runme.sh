...
HD_PWD='F:/project/VGA/vga_rom/vivado/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_rom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_rom.tcl -notrace
