...
HD_PWD='F:/project/VGA/vga_rom/vivado/project_1.runs/rom_vga_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_vga.tcl
