...
HD_PWD='F:/project/VGA/vga_rom/vivado/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_rom.tcl
