...
#
# Generated by export_simulation on Fri Oct 13 14:26:56 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './rom_vga.sh' script.

./rom_vga.sh -reset_run
...
./rom_vga.sh -noclean_files

For more information on the script, please type './rom_vga.sh -help'.
