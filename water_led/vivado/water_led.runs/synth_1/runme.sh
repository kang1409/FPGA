...
HD_PWD='F:/project/water_led/vivado/water_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log water_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source water_led.tcl
