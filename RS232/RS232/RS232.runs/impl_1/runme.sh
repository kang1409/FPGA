...
HD_PWD='F:/project/RS232/RS232/RS232.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rs232.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rs232.tcl -notrace
